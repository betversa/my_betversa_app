...
def compute_kelly_amount(sportsbook_odds, fair_prob, bankroll, multiplier):
    """
    ...
    d = american_to_decimal(sportsbook_odds)
    ...
    if kelly_fraction < 0:
        kelly_fraction = 0
    kelly_dollar = bankroll * multiplier * kelly_fraction
    return f"${kelly_dollar:,.2f}"
